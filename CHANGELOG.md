...
Tag range: `v0.199.5..v0.199.6`.

### Bug Fixes

- **install**: support zsh installer

## [0.199.5] - 2026-08-11

Release summary: 1 bug fix.
Tag range: `v0.199.4..v0.199.5`.

### Bug Fixes

- **desktop**: validate staged Bun runtime

## [0.199.4] - 2026-08-11

Release summary: 1 bug fix and 3 docs updates.
Tag range: `v0.199.3..v0.199.4`.

### Bug Fixes

- **core**: atomically write workspace pointer

### Docs

- **web**: refresh interface references
- **onboarding**: refresh setup guide
- refresh architecture guide
