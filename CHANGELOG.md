...
Release summary: 2 bug fixes and 2 docs updates.
Tag range: `v0.199.2..v0.199.3`.

### Bug Fixes

- **memorybench**: cover Dreaming gate dependencies
- **docs**: stabilize Discord source API anchor

### Docs

- refresh dashboard and source contracts
- refresh operator runbooks

## [0.199.2] - 2026-08-11

Release summary: 7 bug fixes.
Tag range: `v0.199.1..v0.199.2`.

### Bug Fixes

- **daemon**: bound attention suffix coordinates
- **dreaming**: preserve attention evidence during apply
- **dreaming**: accept retained attention coordinates
- **dreaming**: retain attention suffix flags
- **dreaming**: preserve retry boundary
- **dreaming**: make ontology retries safe
- **daemon**: bound Dreaming ontology writes

## [0.199.1] - 2026-08-11

Release summary: 5 bug fixes.
Tag range: `v0.199.0..v0.199.1`.

### Bug Fixes

- **dreaming**: bound continuation selection
- **dreaming**: rotate capped frontiers
- **dreaming**: pin partial evidence
- **dreaming**: continue capped evidence
- **dreaming**: track evidence delivery

## [0.199.0] - 2026-08-11

Release summary: 1 feature and 1 bug fix.
Tag range: `v0.198.3..v0.199.0`.

### Features

- **telemetry**: measure dreaming cache usage

### Bug Fixes

- **telemetry**: correct cache accounting

## [0.198.3] - 2026-08-11

Release summary: 1 bug fix.
Tag range: `v0.198.2..v0.198.3`.

### Bug Fixes

- **daemon**: scope indexed access strictness
...
Tag range: `v0.198.0..v0.198.1`.

### Bug Fixes

- **daemon**: preserve budget on aborted embedding repair
- **daemon**: charge repair budget on persist
- **daemon**: persist embedding repair budget

## [0.198.0] - 2026-08-11

Release summary: 1 feature and 1 bug fix.
Tag range: `v0.197.17..v0.198.0`.

### Features

- **daemon**: bridge Hermes native memory

### Bug Fixes

- **daemon**: reconcile missing native artifacts

## [0.197.17] - 2026-08-11

Release summary: 2 bug fixes.
Tag range: `v0.197.16..v0.197.17`.

### Bug Fixes

- **inference**: preserve upstream timeout fallback
- **inference**: normalize routed deadlines

## [0.197.16] - 2026-08-11

Release summary: 3 bug fixes.
Tag range: `v0.197.15..v0.197.16`.

### Bug Fixes

- **telemetry**: bound routed ACPX labels
- **telemetry**: bound ACPX attribution
- **telemetry**: attribute ACPX locality

## [0.197.15] - 2026-08-11

Release summary: 4 bug fixes and 1 docs update.
Tag range: `v0.197.14..v0.197.15`.

### Bug Fixes

- **import**: recover incomplete duplicates
- **import**: make extraction outcome atomic
- **import**: preserve extraction outcomes
- **import**: surface extraction outcomes

### Docs

- **sources**: document extraction outcomes

## [0.197.14] - 2026-08-11

Release summary: 3 bug fixes.
Tag range: `v0.197.13..v0.197.14`.

### Bug Fixes

- **provenance**: revalidate proposal sources at apply time
- **provenance**: reject invalid proposal sources
- **provenance**: validate proposal sources

## [0.197.13] - 2026-08-11

Release summary: 2 bug fixes.
Tag range: `v0.197.12..v0.197.13`.

### Bug Fixes

- **doctor**: keep Dreaming cause causal
- **doctor**: report readiness truthfully

## [0.197.12] - 2026-08-11

Release summary: 2 bug fixes.
Tag range: `v0.197.11..v0.197.12`.

### Bug Fixes

- **daemon**: extend marketplace proxy startup
- **daemon**: cap marketplace MCP clients

## [0.197.11] - 2026-08-11

Release summary: 1 bug fix and 1 performance improvement.
Tag range: `v0.197.10..v0.197.11`.

### Bug Fixes

- **hooks**: preserve low-signal response shape

### Performance

- **hooks**: skip low-signal prompt recall

## [0.197.10] - 2026-08-11

Release summary: 2 bug fixes.
Tag range: `v0.197.9..v0.197.10`.

### Bug Fixes

- **dashboard**: clarify telemetry data loss
- **dashboard**: show telemetry data loss

## [0.197.9] - 2026-08-11

Release summary: 2 bug fixes.
Tag range: `v0.197.8..v0.197.9`.

### Bug Fixes

- **inference**: preserve Pi zero timeout
- **inference**: bound Pi concurrency

## [0.197.8] - 2026-08-11

Release summary: 2 bug fixes.
Tag range: `v0.197.7..v0.197.8`.

### Bug Fixes

- **core**: guard structural audit rollback
- **core**: retire structural jobs

## [0.197.7] - 2026-08-11

Release summary: 2 bug fixes.
Tag range: `v0.197.6..v0.197.7`.

### Bug Fixes

- **daemon**: honor shared hint recall
- **daemon**: scope prospective hints

## [0.197.6] - 2026-08-11

Release summary: 2 bug fixes and 1 docs update.
Tag range: `v0.197.5..v0.197.6`.

### Bug Fixes

- **daemon**: bound filesystem reads by stat
- **daemon**: async filesystem connector I/O

### Docs

- add sources diagram asset
...
Release summary: 2 bug fixes.
Tag range: `v0.197.3..v0.197.4`.

### Bug Fixes

- **daemon**: refresh queued ACPX deadline
- **daemon**: back off ACPX sterile retries

## [0.197.3] - 2026-08-11

Release summary: 1 bug fix and 1 docs update.
Tag range: `v0.197.2..v0.197.3`.

### Bug Fixes

- **embedding**: reconcile failed vector writes (#1427)

### Docs

- add source import guide

## [0.197.2] - 2026-08-11

Release summary: 1 bug fix.
Tag range: `v0.197.1..v0.197.2`.

### Bug Fixes

- **inference**: cache routing config loads (#1409)

## [0.197.1] - 2026-08-11

Release summary: 1 bug fix.
Tag range: `v0.197.0..v0.197.1`.

### Bug Fixes

- **dashboard**: bound imported documents card (#1425)

## [0.197.0] - 2026-08-11

Release summary: 1 feature.
Tag range: `v0.196.8..v0.197.0`.

### Features

- **daemon**: add bounded resource telemetry (#1429)

## [0.196.8] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.196.7..v0.196.8`.

### Bug Fixes

- **daemon**: repair FTS health and rebuilds (#1412)

## [0.196.7] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.196.6..v0.196.7`.

### Bug Fixes

- **daemon**: serialize skill reconciliation triggers (#1398)

## [0.196.6] - 2026-08-10

Release summary: 2 bug fixes.
Tag range: `v0.196.5..v0.196.6`.

### Bug Fixes

- **dashboard**: aggregate imported documents
- **dashboard**: unify source import modal

## [0.196.5] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.196.4..v0.196.5`.

### Bug Fixes

- **daemon**: bound skill catalog fetches (#1389)

## [0.196.4] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.196.3..v0.196.4`.

### Bug Fixes

- **daemon**: bound marketplace review sync (#1390)

## [0.196.3] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.196.2..v0.196.3`.

### Bug Fixes

- **daemon**: serialize maintenance cycles (#1388)

## [0.196.2] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.196.1..v0.196.2`.

### Bug Fixes

- **daemon**: bound fresh queue diagnostics scans (#1403)

## [0.196.1] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.196.0..v0.196.1`.

### Bug Fixes

- **daemon**: prevent runtime probe stampedes (#1329) (#1399)

## [0.196.0] - 2026-08-10

Release summary: 1 feature.
Tag range: `v0.195.5..v0.196.0`.

### Features

- **ontology**: persist contradiction state beside competing claims (#1377)

## [0.195.5] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.195.4..v0.195.5`.

### Bug Fixes

- **daemon**: release traversal read connections (#1410)

## [0.195.4] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.195.3..v0.195.4`.

### Bug Fixes

- **daemon**: async ACPX process cleanup (#1408)

## [0.195.3] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.195.2..v0.195.3`.

### Bug Fixes

- **daemon**: expose workload pressure diagnostics (#1406)

## [0.195.2] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.195.1..v0.195.2`.

### Bug Fixes

- **daemon**: bound internal self-http calls (#1405)

## [0.195.1] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.195.0..v0.195.1`.

### Bug Fixes

- **daemon**: bound OS Chat inference (#1371)

## [0.195.0] - 2026-08-10

Release summary: 1 feature and 1 bug fix.
Tag range: `v0.194.1..v0.195.0`.

### Features

- **dreaming**: evaluate surprisal-guided attention selection (#1374)

### Bug Fixes

- **daemon**: bound service health probe (#1375)
...
Release summary: 1 bug fix.
Tag range: `v0.193.1..v0.193.2`.

### Bug Fixes

- **memory**: gate hostile content projections (#1385)

## [0.193.1] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.193.0..v0.193.1`.

### Bug Fixes

- **dashboard**: scroll dreaming summary

## [0.193.0] - 2026-08-10

Release summary: 1 feature and 1 bug fix.
Tag range: `v0.192.2..v0.193.0`.

### Features

- unified dashboard source imports (#1370)

### Bug Fixes

- **daemon**: recover document leases on startup

## [0.192.2] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.192.1..v0.192.2`.

### Bug Fixes

- **daemon**: quarantine migration embedding failures (#1387)

## [0.192.1] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.192.0..v0.192.1`.

### Bug Fixes

- **daemon**: repair stale synthesis config (#1384)

## [0.192.0] - 2026-08-10

Release summary: 1 feature.
Tag range: `v0.191.3..v0.192.0`.

### Features

- **telemetry**: attribute dreaming pass target

## [0.191.3] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.191.2..v0.191.3`.

### Bug Fixes

- **daemon**: make entity merges idempotent

## [0.191.2] - 2026-08-10

Release summary: 3 bug fixes.
Tag range: `v0.191.1..v0.191.2`.

### Bug Fixes

- **daemon**: close telemetry repair gaps
- **daemon**: make integrity repair audit atomic
- **daemon**: repair corrupt telemetry indexes

## [0.191.1] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.191.0..v0.191.1`.

### Bug Fixes

- **recall**: parse abbreviated date ranges

## [0.191.0] - 2026-08-10

Release summary: 2 features.
Tag range: `v0.190.0..v0.191.0`.

### Features

- **dashboard**: wire dreaming review suggestions (#1361)
- **dreaming**: retry repaired evidence (#1363)

## [0.190.0] - 2026-08-10

Release summary: 1 feature.
Tag range: `v0.189.2..v0.190.0`.

### Features

- **dashboard**: add telemetry opt-out (#1362)

## [0.189.2] - 2026-08-10

Release summary: 1 performance improvement.
Tag range: `v0.189.1..v0.189.2`.

### Performance

- **context**: stabilize memory injection (#1350)

## [0.189.1] - 2026-08-10

Release summary: 1 bug fix and 1 docs update.
Tag range: `v0.189.0..v0.189.1`.

### Bug Fixes

- **daemon**: bound SQLite writer admission

### Docs

- **telemetry**: catalog health events

## [0.189.0] - 2026-08-10

Release summary: 1 feature.
Tag range: `v0.188.3..v0.189.0`.

### Features

- **telemetry**: expose collector delivery health (#1305)

## [0.188.3] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.188.2..v0.188.3`.

### Bug Fixes

- **daemon**: bound memory capture concurrency (#1355)

## [0.188.2] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.188.1..v0.188.2`.

### Bug Fixes

- remove legacy memory pipeline routing (#1273)

## [0.188.1] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.188.0..v0.188.1`.

### Bug Fixes

- **telemetry**: summarize pipeline operations (#1278) (#1294)

## [0.188.0] - 2026-08-10

Release summary: 1 feature and 2 bug fixes.
Tag range: `v0.187.1..v0.188.0`.

### Features

- **telemetry**: expose accounting provenance

### Bug Fixes

- **telemetry**: preserve mixed coverage
- **telemetry**: correct Pi accounting provenance

## [0.187.1] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.187.0..v0.187.1`.

### Bug Fixes

- **dreaming**: filter reasoning from evidence (#1316)
...
Release summary: 1 bug fix.
Tag range: `v0.185.8..v0.185.9`.

### Bug Fixes

- **telemetry**: disclose CLI command delivery (#1280) (#1290)

## [0.185.8] - 2026-08-10

Release summary: 1 bug fix.
Tag range: `v0.185.7..v0.185.8`.

### Bug Fixes

- **telemetry**: classify deployment role and install provenance (#1288)
...
Release summary: 1 bug fix.
Tag range: `v0.185.0..v0.185.1`.

### Bug Fixes

- **dashboard**: cover remote executor consent
...
Release summary: 1 bug fix.
Tag range: `v0.184.0..v0.184.1`.

### Bug Fixes

- **dashboard**: gate remote memory extraction (#1265)

## [0.184.0] - 2026-08-09

Release summary: 1 feature.
Tag range: `v0.183.1..v0.184.0`.

### Features

- **docs**: launch Starlight documentation
...
Release summary: 1 feature.
Tag range: `v0.182.10..v0.183.0`.

### Features

- **daemon**: deliver cross-agent notifications (#1262)

## [0.182.10] - 2026-08-09

Release summary: 1 bug fix.
Tag range: `v0.182.9..v0.182.10`.

### Bug Fixes

- **daemon**: bound stale session sweep work

## [0.182.9] - 2026-08-09

Release summary: 1 bug fix.
Tag range: `v0.182.8..v0.182.9`.

### Bug Fixes

- **daemon**: report previous exit telemetry
...
Release summary: 2 bug fixes.
Tag range: `v0.182.6..v0.182.7`.

### Bug Fixes

- **hermes**: preserve Python interpreter fallback
- **hermes**: use python3 probe fallback

## [0.182.6] - 2026-08-09

Release summary: 2 bug fixes.
Tag range: `v0.182.5..v0.182.6`.

### Bug Fixes

- **telemetry**: classify skipped embeddings (#1252)
- **desktop**: open Codex OAuth externally

## [0.182.5] - 2026-08-09

Release summary: 1 bug fix.
Tag range: `v0.182.4..v0.182.5`.

### Bug Fixes

- **telemetry**: pair pipeline error types
...
Release summary: 1 bug fix.
Tag range: `v0.182.2..v0.182.3`.

### Bug Fixes

- **dashboard**: make generated routes routable
...
Release summary: 1 bug fix.
Tag range: `v0.182.0..v0.182.1`.

### Bug Fixes

- **telemetry**: stabilize session end identity

## [0.182.0] - 2026-08-08

Release summary: 1 feature.
Tag range: `v0.181.5..v0.182.0`.

### Features

- **dashboard**: make inference routes inspectable

## [0.181.5] - 2026-08-08

Release summary: 1 bug fix.
Tag range: `v0.181.4..v0.181.5`.

### Bug Fixes

- **daemon**: preserve legacy routing migration

## [0.181.4] - 2026-08-08

Release summary: 1 bug fix.
Tag range: `v0.181.3..v0.181.4`.

### Bug Fixes

- **telemetry**: count explicit session boundaries

## [0.181.3] - 2026-08-08

Release summary: 1 bug fix.
Tag range: `v0.181.2..v0.181.3`.

### Bug Fixes

- **dreaming**: require entity summary manifests (#1238)

## [0.181.2] - 2026-08-08

Release summary: 1 bug fix.
Tag range: `v0.181.1..v0.181.2`.

### Bug Fixes

- **daemon**: persist session lifecycle claims (#1237)

## [0.181.1] - 2026-08-08

Release summary: 1 bug fix.
Tag range: `v0.181.0..v0.181.1`.

### Bug Fixes

- **telemetry**: tag development installs (#1225)

## [0.181.0] - 2026-08-08

Release summary: 1 feature, 4 bug fixes, 1 refactor, and 1 docs update.
Tag range: `v0.180.0..v0.181.0`.

### Features

- **telemetry**: add per-install cost tracking

### Bug Fixes

- **telemetry**: preserve active session costs
- **telemetry**: preserve upstream stats contracts
- **telemetry**: recover resumed session attribution
- **sdk**: align telemetry stats response types

### Refactoring

- **telemetry**: use canonical session hashing

### Docs

- **telemetry**: document cost accounting

## [0.180.0] - 2026-08-08

Release summary: 1 feature.
Tag range: `v0.179.2..v0.180.0`.

### Features

- **telemetry**: flush CLI command events (#1217)

## [0.179.2] - 2026-08-08

Release summary: 1 bug fix.
Tag range: `v0.179.1..v0.179.2`.

### Bug Fixes

- **telemetry**: resolve configured routing targets

## [0.179.1] - 2026-08-08

Release summary: 1 bug fix.
Tag range: `v0.179.0..v0.179.1`.

### Bug Fixes

- **daemon**: emit pipeline error telemetry

## [0.179.0] - 2026-08-08

Release summary: 2 features and 2 bug fixes.
Tag range: `v0.178.0..v0.179.0`.

### Features

- **telemetry**: add config snapshot event
- **graphiq**: sync to 4.3.3 — install script, clear+briefing tools, capabilities

### Bug Fixes

- **graphiq**: harden 4.3.3 sync per review
- **dreaming**: format pass summaries as Markdown (#1227)

## [0.178.0] - 2026-08-08

Release summary: 1 feature.
Tag range: `v0.177.0..v0.178.0`.

### Features

- **telemetry**: one-shot first-use events

## [0.177.0] - 2026-08-08

Release summary: 1 feature.
Tag range: `v0.176.12..v0.177.0`.

### Features

- **telemetry**: track recall usage (#1219)

## [0.176.12] - 2026-08-08

Release summary: 1 bug fix.
Tag range: `v0.176.11..v0.176.12`.

### Bug Fixes

- **telemetry**: session.end at real boundaries only

## [0.176.11] - 2026-08-08

Release summary: 1 bug fix.
Tag range: `v0.176.10..v0.176.11`.

### Bug Fixes

- **telemetry**: hash agentId in inference events with the per-install id
...
Release summary: 1 bug fix.
Tag range: `v0.176.7..v0.176.8`.

### Bug Fixes

- **daemon**: resolve attention flags the agent judged and declined

## [0.176.7] - 2026-08-08

Release summary: internal maintenance release with no conventional commit entries captured.
Tag range: `v0.176.6..v0.176.7`.
...
Release summary: 4 bug fixes.
Tag range: `v0.176.5..v0.176.6`.

### Bug Fixes

- **daemon**: cap audit transcript size and archive by rename instead of duplicating (#1163) (#1182)
- **daemon**: consolidate EDEADLK/dataless artifact-read warnings instead of per-file spam (#1161) (#1178)
- **daemon**: probe configured llama.cpp base_url in fallback status check (#1159)
- **daemon**: probe the configured llama.cpp base_url in the embedding fallback
...
Release summary: 1 performance improvement.
Tag range: `v0.176.2..v0.176.3`.

### Performance

- **core**: add memory_entity_mentions (entity_id, memory_id) join index (#1158) (#1166)

## [0.176.2] - 2026-08-08

Release summary: internal maintenance release with no conventional commit entries captured.
Tag range: `v0.176.1..v0.176.2`.
...
Release summary: 3 bug fixes.
Tag range: `v0.176.0..v0.176.1`.

### Bug Fixes

- **daemon**: prevent stale-session sweep starvation, short-session re-fire, and index-defeating query
- **daemon**: dedup stale-session sweep unconditionally (null harness must not re-fire)
- **daemon**: sweep stale live-retained sessions and fire their deferred session-end
...
Release summary: 3 features and 1 docs update.
Tag range: `v0.173.0..v0.174.0`.

### Features

- **telemetry**: emit dreaming.pass with token usage
- **dreaming**: require natural-language pass summaries in runbook
- **dashboard**: dreaming tab with live trace, summary, and ledger

### Docs

- **dashboard**: add dreaming tab screenshots

## [0.173.0] - 2026-08-07

Release summary: 1 feature.
Tag range: `v0.172.0..v0.173.0`.

### Features

- **telemetry**: emit install.activated on first run

## [0.172.0] - 2026-08-07

Release summary: 1 feature.
Tag range: `v0.171.1..v0.172.0`.

### Features

- **telemetry**: emit pipeline.embedding with stats (#1181)

## [0.171.1] - 2026-08-07

Release summary: 3 bug fixes and 1 docs update.
Tag range: `v0.171.0..v0.171.1`.

### Bug Fixes

- **daemon**: honor SIGNET_TELEMETRY_OPTOUT
- **dreaming**: close hygiene attention pin gaps found in adversarial review (#1168)
- **dreaming**: pin hygiene archive targets by subjectRef when flag details omit ids (#1168)

### Docs

- mark #1026 usage analytics done

## [0.171.0] - 2026-08-07

Release summary: 4 features and 1 bug fix.
Tag range: `v0.170.0..v0.171.0`.

### Features

- **telemetry**: PostHog ping, default-on disclosure
- **scripts**: GitHub release download stats (Phase 3 of #1026)
- **daemon,cli**: Phase 2 opt-in telemetry with open log + lifecycle events (#1026)
- **wrapper**: anonymous post-install telemetry ping with opt-out (#1026)

### Bug Fixes

- **telemetry**: write setup opt-out to memory.pipelineV2

## [0.170.0] - 2026-08-07

Release summary: 1 feature.
Tag range: `v0.169.1..v0.170.0`.

### Features

- **telemetry**: per-install PostHog analytics

## [0.169.1] - 2026-08-07

Release summary: 1 bug fix.
Tag range: `v0.169.0..v0.169.1`.

### Bug Fixes

- **daemon**: defer summary jobs when synthesis resolver uninitialised

## [0.169.0] - 2026-08-07

Release summary: 1 feature.
Tag range: `v0.168.0..v0.169.0`.

### Features

- **daemon**: record embedding token usage at the fetch boundary (#1154) (#1156)
...
Tag range: `v0.166.0..v0.167.0`.

### Features

- **cli**: export session transcripts for training/fine-tuning

### Bug Fixes

- **dreaming**: watermark tracks surfaced evidence
- **daemon**: close adversarial-review findings on #1148
- **daemon**: surface daemon deaths with lifecycle record, exit-path logs, and concurrency load test (#1148)

## [0.166.0] - 2026-08-07

Release summary: 5 features and 3 bug fixes.
Tag range: `v0.165.0..v0.166.0`.

### Features

- **daemon**: supersedes lineage at remember-write time + lineage chain (#1138)
- **daemon**: hygiene over-cap detector flags consolidation targets (#1138)
- **daemon**: merge_aspects consolidation op + bump graph caps to 20/50 (#1138)
- **daemon**: write-gate aspect/attribute caps that force supersession (#1138)
- **web**: redesign marketing site and docs system

### Bug Fixes

- **daemon**: close remaining adversarial-review findings on #1147
- **daemon**: close cap bypasses + lineage scope leak found in adversarial review (#1138)
- **web**: unshadow Astro home page from stale static index.html
...
Release summary: 1 bug fix.
Tag range: `v0.164.4..v0.164.5`.

### Bug Fixes

- **daemon**: drop vanished native-memory artifacts, back off failed reads (#1142) (#1146)
...
Release summary: 1 refactor.
Tag range: `v0.157.0..v0.157.1`.

### Refactoring

- **positioning**: focus public Signet language on memory and secrets

## [0.157.0] - 2026-07-30

Release summary: 1 feature and 1 bug fix.
Tag range: `v0.156.4..v0.157.0`.

### Features

- **daemon**: migrate embeddings without recall downtime

### Bug Fixes

- **daemon**: pass embedding migration typecheck

## [0.156.4] - 2026-07-30

Release summary: 2 bug fixes.
Tag range: `v0.156.3..v0.156.4`.

### Bug Fixes

- **daemon**: preserve aggregate recall routing
- **daemon**: enforce production typecheck

## [0.156.3] - 2026-07-30

Release summary: 1 bug fix.
Tag range: `v0.156.2..v0.156.3`.

### Bug Fixes

- **daemon**: handle missing Bun SQLite rows

## [0.156.2] - 2026-07-30

Release summary: 3 bug fixes.
Tag range: `v0.156.1..v0.156.2`.

### Bug Fixes

- **daemon**: allow nullable dependency reasons
- **daemon**: preserve nullable dependency reasons
- **daemon**: type source ingestion contracts
...
Release summary: 1 bug fix.
Tag range: `v0.154.5..v0.154.6`.

### Bug Fixes

- **dashboard**: sync legacy extraction label with routing target (#1017) (#1023)

## [0.154.5] - 2026-07-24

Release summary: 2 bug fixes.
Tag range: `v0.154.4..v0.154.5`.

### Bug Fixes

- **connector-base**: stop baking stale SIGNET_PATH into managed extensions (#1020)
- **embedding**: align assetPathsOverride key names with EmbeddingHandleOptions (#1018) (#1021)

## [0.154.4] - 2026-07-24

Release summary: 1 bug fix.
Tag range: `v0.154.3..v0.154.4`.

### Bug Fixes

- **daemon**: validate routing config references on load (#1005) (#1019)

## [0.154.3] - 2026-07-24

Release summary: 1 bug fix.
Tag range: `v0.154.2..v0.154.3`.

### Bug Fixes

- **repair**: never report 100% embedding coverage while gaps remain (#906) (#1014)

## [0.154.2] - 2026-07-24

Release summary: 1 bug fix.
Tag range: `v0.154.1..v0.154.2`.

### Bug Fixes

- **test**: await native smoke child teardown (#1010)
...
Release summary: 2 features, 3 bug fixes, and 1 refactor.
Tag range: `v0.153.0..v0.154.0`.

### Features

- **dashboard**: rework agents as identity & custody cards
- **dashboard**: rename Tasks→Agents, add identity and access config view

### Bug Fixes

- **dashboard**: rework agents — dense cards, session count, tactile chips
- **dashboard**: compact agent cards — spec bar, prompt tags, focus telemetry
- **dashboard**: dissolve dreaming card head, normalize code spans

### Refactoring

- **connector-base**: centralize MCP command resolution (#1008)
...
Release summary: 1 feature.
Tag range: `v0.150.5..v0.151.0`.

### Features

- **daemon**: recover missed native transcripts (#998)

## [0.150.5] - 2026-07-23

Release summary: 1 bug fix.
Tag range: `v0.150.4..v0.150.5`.

### Bug Fixes

- **embedding**: harden native WASM inference (#996)
...
Release summary: 1 bug fix and 1 docs update.
Tag range: `v0.150.2..v0.150.3`.

### Bug Fixes

- **acpx**: harden sterile OpenCode inference (#985)

### Docs

- update roadmap to reflect current priorities (dashboard, desktop, config UX)

## [0.150.2] - 2026-07-23

Release summary: internal maintenance release with no conventional commit entries captured.
Tag range: `v0.150.1..v0.150.2`.
...
Release summary: 1 feature.
Tag range: `v0.148.10..v0.149.0`.

### Features

- **dashboard**: select connected providers as backends + compact rows (#997)

## [0.148.10] - 2026-07-23

Release summary: 1 bug fix.
Tag range: `v0.148.9..v0.148.10`.

### Bug Fixes

- **dashboard**: provider wall completeness, optional keys, OAuth window (#995)
...
Release summary: 1 bug fix.
Tag range: `v0.148.4..v0.148.5`.

### Bug Fixes

- **acpx**: prevent recursive background hooks (#980)

## [0.148.4] - 2026-07-22

Release summary: 1 bug fix.
Tag range: `v0.148.3..v0.148.4`.

### Bug Fixes

- **memory**: stop session-start injection from advancing access tracking (#972)

## [0.148.3] - 2026-07-22

Release summary: 1 bug fix.
Tag range: `v0.148.2..v0.148.3`.

### Bug Fixes

- **daemon**: restore provider-status contract after #949 (#960) (#965)
...
Release summary: 1 bug fix.
Tag range: `v0.148.0..v0.148.1`.

### Bug Fixes

- **daemon**: forward per-call reasoning ThinkingLevel to pi-ai (#959) (#963)
...
Release summary: 1 bug fix.
Tag range: `v0.145.4..v0.145.5`.

### Bug Fixes

- **dashboard**: make daily brief a single memory question (#874)
...
Release summary: 1 bug fix.
Tag range: `v0.143.1..v0.143.2`.

### Bug Fixes

- **daemon**: harden session transcript capture
...
Release summary: 1 bug fix.
Tag range: `v0.140.3..v0.140.4`.

### Bug Fixes

- **daemon**: enforce scoped connector memory access (#842)
...
Release summary: 1 feature.
Tag range: `v0.138.34..v0.139.0`.

### Features

- **connectors**: support portable remote daemon auth (#836)
...
Release summary: 1 bug fix.
Tag range: `v0.138.32..v0.138.33`.

### Bug Fixes

- **ci**: copy native-manifest.json into npm wrapper before publish

## [0.138.32] - 2026-06-10

Release summary: 1 bug fix.
Tag range: `v0.138.31..v0.138.32`.

### Bug Fixes

- **ci**: restore connector tarball and manifest to verify expected list
...
Release summary: 1 bug fix.
Tag range: `v0.138.29..v0.138.30`.

### Bug Fixes

- **ci**: remove connector tarball and manifest from release verify step
...
Release summary: 1 bug fix.
Tag range: `v0.138.20..v0.138.21`.

### Bug Fixes

- **daemon**: recover reset summaries from prompt transcripts (#824)
...
Release summary: 1 bug fix.
Tag range: `v0.138.18..v0.138.19`.

### Bug Fixes

- **release**: embed native cli version (#823)

## [0.138.18] - 2026-06-03

Release summary: 1 bug fix.
Tag range: `v0.138.17..v0.138.18`.

### Bug Fixes

- **cli**: keep rust daemon runtime opt-in (#822)

## [0.138.17] - 2026-06-03

Release summary: 1 bug fix.
Tag range: `v0.138.16..v0.138.17`.

### Bug Fixes

- **release**: pack native tarballs from local paths
...
Release summary: 1 bug fix and 1 docs update.
Tag range: `v0.138.13..v0.138.14`.

### Bug Fixes

- **install**: bundle native assets in npm package

### Docs

- **readme**: tighten positioning flow
...
Release summary: internal maintenance release with no conventional commit entries captured.
Tag range: `bundle-0.138.10-77038a01ac7e31fb67a5ffd1bae674c239d7cbbc..v0.138.12`.
...
Release summary: 1 bug fix.
Tag range: `bundle-0.138.6-3d1753b09bace3366000041420bcfbe224cfd108..v0.138.9`.

### Bug Fixes

- **daemon-rs**: make transcript recapture idempotent (#808)
...
Release summary: 1 bug fix.
Tag range: `bundle-0.138.1-64dbbe21cdf073d12d57db0ab91a7b575d610feb..v0.138.3`.

### Bug Fixes

- **hooks**: harden prompt entity context filtering (#798)
...
Release summary: 1 bug fix.
Tag range: `bundle-0.137.4-9221d683926f580acfef9560c2522dadd65e64d2..v0.138.1`.

### Bug Fixes

- **daemon**: route prompt context through attributes (#796)
...
Release summary: 1 feature.
Tag range: `v0.136.1..v0.137.0`.

### Features

- **dashboard**: add Discord source operations panel (#784)

## [0.136.1] - 2026-05-25

Release summary: 1 bug fix.
Tag range: `bundle-0.133.1-340433ec151a10768fc01cade3eb50cb1db6428d..v0.136.1`.

### Bug Fixes

- **daemon**: surface graph extraction diagnostics (#783)
...
Release summary: 1 feature.
Tag range: `bundle-0.133.0-ea0e42b7455a256171bc65b1bbabf5807a739908..v0.135.0`.

### Features

- **unreal**: add npc backend prototype (#780)
...
Release summary: 1 bug fix.
Tag range: `bundle-0.131.0-47b28637fcac2cd61fe51b243f17e6c5a45750c8..v0.133.1`.

### Bug Fixes

- **codex**: avoid duplicate native plugin hooks (#776)

## [0.133.0] - 2026-05-24

Release summary: 1 feature and 1 bug fix.
Tag range: `bundle-0.130.1-aabb97eb8290dcd50dfc09d8c7e330f0c4696104..v0.133.0`.

### Features

- **sources**: resume Discord history backfill (#775)

### Bug Fixes

- **connector-codex**: remove stale MCP before plugin install (#774)

## [0.132.0] - 2026-05-24

Release summary: 1 feature.
Tag range: `bundle-0.130.1-13d784943001995e248894b6742fa2eec17144d8..v0.132.0`.
...
Release summary: 1 feature.
Tag range: `bundle-0.130.0-32aec04a32761016eab72a6394ae822493efa911..v0.131.0`.

### Features

- **sources**: add dashboard snapshot operations (#771)
...
Release summary: 1 feature.
Tag range: `bundle-0.127.0-48ae6da32e980e4603ff18446579b287f2f5c82b..v0.130.0`.

### Features

- **sources**: project provider artifacts into graph (#769)
...
Release summary: 1 feature.
Tag range: `bundle-0.125.2-c660ef134864110168f775acbc7738d90057914a..v0.128.0`.

### Features

- **sources**: add GitHub source provider (#764)

## [0.127.0] - 2026-05-24

Release summary: 1 feature.
Tag range: `bundle-0.125.0-28c94cda5255af5684e8fe9652217dff0391db60..v0.127.0`.

### Features

- **sources**: add source snapshot operations (#765)

## [0.126.0] - 2026-05-24

Release summary: 1 feature.
Tag range: `bundle-0.124.5-2fba3df177b3db6d3ea6b5cde96b5d7e34744e3c..v0.126.0`.

### Features

- **sources**: import Discord desktop cache (#763)
...
Release summary: 1 bug fix.
Tag range: `bundle-0.123.22-02e143b887d37c10759ec10119ab111ad1853abf..v0.124.2`.

### Bug Fixes

- **inference**: route direct API pipeline providers (#751)
...
Release summary: internal maintenance release with no conventional commit entries captured.
Tag range: `bundle-0.123.19-e1fbc594b075cfbe486120460fd0c667241f9d50..v0.123.20`.
...
Release summary: 1 performance improvement.
Tag range: `bundle-0.123.16-5d8b6cba94dae48c816cfa375de0e801cddca008..v0.123.18`.

### Performance

- **daemon**: speed up aggregate recall (#742)

## [0.123.17] - 2026-05-21

Release summary: 1 bug fix.
Tag range: `bundle-0.123.16-0c490d06ed3d0219d4e11876a09be2402728338e..v0.123.17`.

### Bug Fixes

- **memory**: harden aggregate recall dogfood paths (#741)

## [0.123.16] - 2026-05-20

Release summary: 1 bug fix.
Tag range: `bundle-0.123.14-81f5e315979108856f6c14bd3966e035af76cb5f..v0.123.16`.

### Bug Fixes

- **memory**: harden aggregate recall (#739)
...
Release summary: internal maintenance release with no conventional commit entries captured.
Tag range: `bundle-0.123.13-b38908f62be378cd18c978f67c30a81001078bb3..v0.123.14`.
...
Release summary: 1 feature.
Tag range: `v0.111.14..v0.112.0`.

### Features

- **inference**: add ACPX routing backend (#642)

## [0.111.14] - 2026-05-07

Release summary: internal maintenance release with no conventional commit entries captured.
Tag range: `v0.111.13..v0.111.14`.
...
Release summary: 1 docs update.
Tag range: `v0.111.11..v0.111.12`.

### Docs

- refine ontology artifact model
...
Release summary: 1 bug fix.
Tag range: `v0.111.9..v0.111.10`.

### Bug Fixes

- **daemon**: stabilize Obsidian source sync (#638)

## [0.111.9] - 2026-05-07

Release summary: 1 bug fix.
Tag range: `v0.111.8..v0.111.9`.

### Bug Fixes

- **sources**: index Obsidian sources asynchronously (#634)
